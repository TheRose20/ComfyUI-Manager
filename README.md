...
2. Download [scripts/install-manager-for-portable-version.bat](scripts/install-manager-for-portable-version.bat) into installed `"ComfyUI_windows_portable"` directory
